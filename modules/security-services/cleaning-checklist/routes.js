...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        res.send(`
            ...
            <head>
                <meta charset="UTF-8">
                <title>HO Dbayeh & Zouk Toilets and Canteens Checklist - ${process.env.APP_NAME}</title>
                <style>
            ...
            <body>
                <div class="header">
                    <h1>🚽 HO Dbayeh & Zouk Toilets and Canteens Checklist</h1>
...
router.get('/:id', async (req, res) => {
    ...
    try {
        ...
        res.send(`
            ...
            <head>
                <meta charset="UTF-8">
                <title>HO Dbayeh & Zouk Toilets and Canteens Checklist - ${checklist.LocationName} - ${process.env.APP_NAME}</title>
                <style>
                    * { margin: 0; padding: 0; box-sizing: border-box; }
                    body { 
                        font-family: 'Segoe UI', Arial, sans-serif; 
