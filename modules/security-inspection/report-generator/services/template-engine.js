    ...
    buildChart(data) {
        ...
        if (categories.length > 0) {
            ...
            for (const category of categories) {
                ...
                chartColors.push(categoryScore >= threshold ? '#b91c1c' : '#dc2626'); // Darker green/red for categories
                ...
                for (const catSection of category.sections) {
                    ...
                    if (sectionScore) {
                        ...
                        chartColors.push(sectionScore.percentage >= threshold ? '#dc2626' : '#ef4444');
            ...
            if (uncategorized.length > 0) {
                ...
                chartColors.push(uncatScore >= threshold ? '#b91c1c' : '#dc2626');
                chartTypes.push('category');
                ...
                for (const section of uncategorized) {
                    ...
                    chartColors.push(section.percentage >= threshold ? '#dc2626' : '#ef4444');
                    chartTypes.push('section');
    ...
    getDefaultStyles() {
        return `
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .performance-banner.status-pass { background: linear-gradient(135deg, #dc2626, #b91c1c); color: white; }
